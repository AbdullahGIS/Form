...
const Form3 = () => {
    ...
    const handleCropDetailChange = ( field: keyof CropDetail, value: any) => {
        setInputFormData((prevData) => {
                    ...
                    {inputFormData.cropDetails.map((cropDetail, index) => (
                        <div key={index} className="crop-detail">
                            <select
                                ...
                                onChange={(e) => handleCropDetailChange( 'cropName', e.target.value)}
                                required
                            >
                            ...
                            <Select
                                ...
                                onChange={(selectedOptions) => handleCropDetailChange( 'cropSeason', selectedOptions.map((option) => option.value))}
                                required
                            />
                        </div>
                    ))}
